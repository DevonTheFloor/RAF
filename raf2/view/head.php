...
<html lang="fr">
  <head>
    ...
    <link href="/RAF/raf2/assets/css/bootstrap.css" rel="stylesheet">
   <link href="https://use.fontawesome.com/releases/v5.8.0/css/all.css" rel="stylesheet">
    <link href="/RAF/raf2/sass/raf2.css" rel="stylesheet">
  </head>
  <body>
    <div class="container-fluid">
      <header class="row nav-menu">
          <div class="col-3 col-sm-3 col-lg-3">
            <a href="#" class="btn btn-primary btn-primary"><i class="fas fa-chalkboard-teacher"></i> COURS</a>
          </div>
          <div class="col-3 col-sm-3 col-lg-3">
